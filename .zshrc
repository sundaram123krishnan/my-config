...
if [ -f /home/sundaram/.config/synth-shell/synth-shell-prompt.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /home/sundaram/.config/synth-shell/synth-shell-prompt.sh
fi
alias vim='nvim'
export EDITOR='nvim'
source /home/sundaram/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
